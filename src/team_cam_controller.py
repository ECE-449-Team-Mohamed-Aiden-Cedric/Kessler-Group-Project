...
class TeamCAMController(KesslerController): 
    def __init__(self):
        ...
        converted_chromosome = self.__convert_chromosome(chromosome)
    ...
    def __convert_chromosome(self, chromosome):
        ...
        values.extend([-0.01, 1.01])
        values = sorted(values)
        ship_stopping_distance_gene = { # type: ignore
            "Z": tuple(values[0:3]),
            "PS": tuple(values[1:4]),
            "PM": tuple(values[2:5]),
            "PL": tuple(values[3:6])
        ...
        values.extend([-0.01, 1.01])
        values = sorted(values)
        mine_distance_gene = { # type: ignore
            "Z": tuple(values[0:3]),
            "PS": tuple(values[1:4]),
            "PM": tuple(values[2:5]),
            "PL": tuple(values[3:6])
        ...
        values.extend([-0.01, 1.01])
        values = sorted(values)
        asteroid_distance_gene = { # type: ignore
            "Z": tuple(values[0:3]),
            "PS": tuple(values[1:4]),
            "PM": tuple(values[2:5]),
            "PL": tuple(values[3:6])
    ...
    def __setup_fuzzy_sets(self, chromosome) -> tuple[ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Consequent, ctrl.Consequent, ctrl.Consequent, ctrl.Consequent]:
        ...
        bullet_time_gene = chromosome["bullet_time"]
        ...
        theta_delta_gene = chromosome["theta_delta"]
        ...
        ship_speed_gene = chromosome["ship_speed"]
        ...
        ship_stopping_distance_gene = chromosome["ship_stopping_distance"]
        ...
        mine_distance_gene = chromosome["mine_distance"]
        ...
        asteroid_distance_gene = chromosome["asteroid_distance"]
        ...
        # Hard-coded for a game step of 1/30 seconds
        ship_turn_gene = chromosome["ship_turn"]
    ...
    def __get_rules(
        ...
        rules: list[ctrl.Rule] = [
            ...
            ctrl.Rule(ship_stopping_distance['PM'] & asteroid_distance['PL'] & (mine_distance['PM'] | mine_distance['PL']), ship_thrust['PS']),
            ...
            ctrl.Rule(ship_stopping_distance['PS'] & asteroid_distance['PM'] & (mine_distance['PM'] | mine_distance['PL']), ship_thrust['PS']),
            ...
            ctrl.Rule(ship_stopping_distance['Z'] & asteroid_distance['Z'] & mine_distance['PS'], ship_thrust['NL']),
            ctrl.Rule(ship_stopping_distance['Z'] & asteroid_distance['Z'] & (mine_distance['PM'] | mine_distance['PL']), ship_thrust['NL']),
            ctrl.Rule(ship_stopping_distance['Z'] & asteroid_distance['PS'] & mine_distance['Z'], ship_thrust['NL']),
            ctrl.Rule(ship_stopping_distance['Z'] & asteroid_distance['PS'] & mine_distance['PS'], ship_thrust['NL']),
            ctrl.Rule(ship_stopping_distance['Z'] & asteroid_distance['PS'] & (mine_distance['PM'] | mine_distance['PL']), ship_thrust['NL']),
