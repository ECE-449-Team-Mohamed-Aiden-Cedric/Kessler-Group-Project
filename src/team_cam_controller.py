...
class TeamCAMController(KesslerController): 
    def __init__(self, chromosome: Chromosome):
        ...
        ## Aiden Teal ##
        asteroid_velocity: ctrl.Antecedent
        asteroid_distance: ctrl.Antecedent
        ## Aiden Teal ##
        
        ## Aiden Teal ##
        self.__asteroid_velocity_range: tuple[float, float] = (0, 91)
        self.__asteroid_distance_range: tuple[float, float] = (0, 500)
        ## Aiden Teal ##
        ...
        self.__ship_speed_range: tuple[float, float] = (-241, 241) # m/s
        ...
        self.__ship_thrust_range: tuple[float, float] = (-481.0, 481.0) # m/s^2
        ...
        bullet_time, theta_delta, ship_speed, ship_stopping_distance, mine_distance, ship_turn, ship_fire, drop_mine, ship_thrust, asteroid_velocity, asteroid_distance = self.__setup_fuzzy_sets(converted_chromosome)
        self.__rules: list[ctrl.Rule] = self.__get_rules(bullet_time, theta_delta, ship_speed, ship_stopping_distance, mine_distance, ship_turn, ship_fire, drop_mine, ship_thrust, asteroid_velocity, asteroid_distance)
    ...
    def __convert_chromosome(self, chromosome: Chromosome) -> ConvertedChromosome:
        ...
        values: list[float] = chromosome_list[43:46]
        values.extend([-0.01, 1.01])
        values = sorted(values)
        asteroid_velocity_gene: Gene = {
            "S": tuple(values[0:3]),
            "M": tuple(values[1:4]),
            "L": tuple(values[2:5])
        }
        asteroid_velocity_gene = self.__scale_gene(
            asteroid_velocity_gene,
            self.__asteroid_velocity_range[0],
            self.__asteroid_velocity_range[1]
        )
        
        values: list[float] = chromosome_list[46:49]
        values.extend([-0.01, 1.01])
        values = sorted(values)
        asteroid_distance_gene: Gene = {
            "S": tuple(values[0:3]),
            "M": tuple(values[1:4]),
            "L": tuple(values[2:5])
        }
        ...
        converted_chromosome: ConvertedChromosome = {
            ...
            "asteroid_velocity": asteroid_velocity_gene,
    ...
    def __setup_fuzzy_sets(self, chromosome: ConvertedChromosome) -> tuple[ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Antecedent, ctrl.Consequent, ctrl.Consequent, ctrl.Consequent, ctrl.Consequent, ctrl.Antecedent, ctrl.Antecedent]:
        ...
        ship_speed: ctrl.Antecedent = ctrl.Antecedent(np.arange(self.__ship_speed_range[0], self.__ship_speed_range[1], 1), 'ship_speed')
        ...
        asteroid_velocity: ctrl.Antecedent = ctrl.Antecedent(np.arange(self.__asteroid_velocity_range[0], self.__asteroid_velocity_range[1], 1), 'asteroid_velocity')
        ...
        ## Aiden Teal ##
        asteroid_velocity_gene: Gene = chromosome["asteroid_velocity"]
        asteroid_velocity["S"] = fuzz.trimf(asteroid_velocity.universe, asteroid_velocity_gene["S"])
        asteroid_velocity["M"] = fuzz.trimf(asteroid_velocity.universe, asteroid_velocity_gene["M"])
        asteroid_velocity["L"] = fuzz.trimf(asteroid_velocity.universe, asteroid_velocity_gene["L"])
        
        asteroid_distance_gene: Gene = chromosome["asteroid_distance"]
        asteroid_distance["S"] = fuzz.trimf(asteroid_distance.universe, asteroid_distance_gene["S"])    
        asteroid_distance["M"] = fuzz.trimf(asteroid_distance.universe, asteroid_distance_gene["M"])    
        asteroid_distance["L"] = fuzz.trimf(asteroid_distance.universe, asteroid_distance_gene["L"])    
        ## Aiden Teal ##
        ...
        return (bullet_time, theta_delta, ship_speed, ship_stopping_distance, mine_distance, ship_turn, ship_fire, drop_mine, ship_thrust, asteroid_velocity, asteroid_distance)
    ...
    def __get_rules(
        ...
        rules: list[ctrl.Rule] = [
            ...
            ctrl.Rule(mine_distance['Z'] & (ship_speed['NS'] | ship_speed['NM'] | ship_speed['NL'] | ship_speed['Z']), ship_thrust['NL']),
            ctrl.Rule(mine_distance['Z'] & (ship_speed['PS'] | ship_speed['PM'] | ship_speed['PL']), ship_thrust['PL']),
            ctrl.Rule(mine_distance['PS'] & (ship_speed['NS'] | ship_speed['NM'] | ship_speed['NL'] | ship_speed['Z']), ship_thrust['NM']),
            ctrl.Rule(mine_distance['PS'] & (ship_speed['PS'] | ship_speed['PM'] | ship_speed['PL']), ship_thrust['PM']),
            ctrl.Rule(mine_distance['PM'] & (ship_speed['NS'] | ship_speed['NM'] | ship_speed['NL'] | ship_speed['Z']), ship_thrust['NS']),
            ctrl.Rule(mine_distance['PM'] & (ship_speed['PS'] | ship_speed['PM'] | ship_speed['PL']), ship_thrust['PS']),
            ctrl.Rule(mine_distance['PL'] & (ship_speed['NS'] | ship_speed['NM'] | ship_speed['NL'] | ship_speed['Z']), ship_thrust['Z']),
            ctrl.Rule(mine_distance['PL'] & (ship_speed['PS'] | ship_speed['PM'] | ship_speed['PL']), ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['L'] & (ship_speed['NL'] | ship_speed['NM']), ship_thrust['PL']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['L'] & (ship_speed['NS'] | ship_speed['Z']), ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['L'] & ship_speed['PS'], ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['L'] & ship_speed['PM'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['L'] & ship_speed['PL'], ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['M'] & ship_speed['NL'], ship_thrust['PL']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['M'] & (ship_speed['NM'] | ship_speed['Z']), ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['M'] & (ship_speed['NS'] | ship_speed['PS']), ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['M'] & ship_speed['PM'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['M'] & ship_speed['PL'], ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['S'] & (ship_speed['NL'] | ship_speed['Z']), ship_thrust['PL']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['S'] & (ship_speed['NM'] | ship_speed['NS']), ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['S'] & ship_speed['PS'], ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['S'] & ship_speed['PM'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['L'] & asteroid_velocity['S'] & ship_speed['PL'], ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['L'] & (ship_speed['NL'] | ship_speed['Z']), ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['L'] & (ship_speed['NM'] | ship_speed['PS']), ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['L'] & ship_speed['NS'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['L'] & ship_speed['PM'], ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['L'] & ship_speed['PL'], ship_thrust['NM']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['M'] & (ship_speed['NL'] | ship_speed['Z']), ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['M'] & (ship_speed['PS'] | ship_speed['PM']), ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['M'] & ship_speed['NM'], ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['M'] & ship_speed['NS'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['M'] & ship_speed['PL'], ship_thrust['NM']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['S'] & (ship_speed['NM'] | ship_speed['Z']), ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['S'] & (ship_speed['PS'] | ship_speed['PM']), ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['S'] & ship_speed['NL'], ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['S'] & ship_speed['NS'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['M'] & asteroid_velocity['S'] & ship_speed['PL'], ship_thrust['NM']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['L'] & (ship_speed['PS'] | ship_speed['PM'] | ship_speed['PL']), ship_thrust['NL']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['L'] & ship_speed['NL'], ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['L'] & ship_speed['NM'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['L'] & ship_speed['NS'], ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['L'] & ship_speed['Z'], ship_thrust['NM']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & (ship_speed['Z'] | ship_speed['PS']), ship_thrust['NM']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & (ship_speed['PL'] | ship_speed['PM']), ship_thrust['NL']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & ship_speed['NL'], ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & ship_speed['NM'], ship_thrust['Z']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & ship_speed['NS'], ship_thrust['NS']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & (ship_speed['Z'] | ship_speed['PS']), ship_thrust['NM']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & (ship_speed['PL'] | ship_speed['PM']), ship_thrust['NL']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & ship_speed['NM'], ship_thrust['PS']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & ship_speed['NL'], ship_thrust['PM']),
            ctrl.Rule(asteroid_distance['S'] & asteroid_velocity['M'] & ship_speed['NS'], ship_thrust['Z'])
        ]
    ...
    def actions(self, ship_state: Dict[str, Any], game_state: immutabledict[Any, Any]) -> Tuple[float, float, bool, bool]:
        ...
        self.__control_system_simulation.input['asteroid_velocity'] = asteroid_vel
        self.__control_system_simulation.input['asteroid_distance'] = closest_asteroid["dist"]
        closest_asteroid_dist = closest_asteroid["dist"]
        #print(f"ship speed: {ship_speed}, asteroid velocity: {asteroid_vel}, closest asteroid: {closest_asteroid_dist}")
